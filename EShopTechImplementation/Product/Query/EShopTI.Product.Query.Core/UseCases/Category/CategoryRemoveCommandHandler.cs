...
public class CategoryRemoveCommandHandler : IRequestHandler<CategoryRemoveCommand, Domain.Aggregates.Category.Category>
{
    ...
    public async Task<Domain.Aggregates.Category.Category> Handle(CategoryRemoveCommand request, CancellationToken cancellationToken)
    {
